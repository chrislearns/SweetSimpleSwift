...
public extension String {
  ...
  func toSFSymbol() -> Image {
    ...
    func isValidPassword(minCharacters: Int, requirements: [PasswordRequirements] = [.oneDigit, .oneLowercase, .oneUppercase]) -> Bool {
    ...
    func withAffix(_ affixValue: String, location: Affix, force: Bool = false) -> String {
